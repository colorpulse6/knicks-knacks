...
export default function BooksListScreen({ navigation }: BooksListScreenProps) {
  ...
  if (error) {
    return (
      ...
      >
        <Text style={[styles.errorText, { color: themeObj.accent }]}>
          ...
          <View>
            ...
            {expandedYears[year] && (
              <View style={{ paddingLeft: 12 }}>
                {Object.keys(groupedBooks[year])
                  .sort(
                    (a, b) =>
                      dayjs(b, "MMMM").month() - dayjs(a, "MMMM").month()
                  )
                  .map((month) => (
                    <View key={month} style={{ marginBottom: 12 }}>
                      ...
                      {groupedBooks[year][month].map((item: any) => (
                        ...
                        >
                          ...
                          <View style={{ flex: 1 }}>
                            <Text
                              style={[styles.title, { color: themeObj.text }]}
                            >
                              {item.title}
                            </Text>
                            <Text
                          ...
                          <TouchableOpacity
                            onPress={() =>
                              handleDelete(item.id, item.user_id, item.title)
                            }
