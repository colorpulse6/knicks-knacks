...
import { ModelSelector, SelectedLLM } from "./ModelSelector";
import { LLMResponsePanel } from "./LLMResponsePanel";
import { LLMComparativeAnalysis } from "./LLMComparativeAnalysis";
import { ChevronDown, ChevronUp, PlayCircle } from "lucide-react";
import Link from "next/link";
import { useApiKeyStore } from "../providers/ApiKeyProvider";
import { LLM_REGISTRY } from "../core/llm-registry";
import { CostCalculator } from "./CostCalculator";
import { ClientOnlyApiKeyProvider } from "./ClientOnlyApiKeyProvider";
...
// Main BotBattle page component
function BotBattlePageContent() {
...
export default function BotBattlePage() {
  return (
    <ClientOnlyApiKeyProvider>
      <BotBattlePageContent />
    </ClientOnlyApiKeyProvider>
  );
}
